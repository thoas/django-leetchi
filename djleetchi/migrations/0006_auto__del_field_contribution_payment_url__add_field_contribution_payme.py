...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contribution.payment_url'
        db.delete_column('leetchi_contribution', 'payment_url')

        # Adding field 'Contribution.payment_method_type'
        db.add_column('leetchi_contribution', 'payment_method_type',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Contribution.payment_url'
        db.add_column('leetchi_contribution', 'payment_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Contribution.payment_method_type'
        db.delete_column('leetchi_contribution', 'payment_method_type')
    ...
    models = {
        ...
        u'djleetchi.contribution': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'culture': ('django.db.models.fields.CharField', [], {'max_length': '5', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_completed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_success': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'payment_method_type': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
