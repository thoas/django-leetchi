...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contribution.culture'
        db.add_column('leetchi_contribution', 'culture',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contribution.culture'
        db.delete_column('leetchi_contribution', 'culture')
    ...
    models = {
        ...
        u'djleetchi.contribution': {
            ...
            'payment_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
